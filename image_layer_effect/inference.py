...
#     with open(os.path.join(model_dir, 'color-model.pth'), 'rb') as f:
#     # with open(os.path.join(model_dir, 'depth-model.pth'), 'rb') as f:
#     # with open(os.path.join(model_dir, 'edge-model.pth'), 'rb') as f:
